...
| [cairo](https://www.cairographics.org/) | 1.16.0 | cairo/1.16.0 | 2D graphics library | libxext/1.3.4, libpng/1.6.37, freetype/2.10.1, pixman/0.38.4 |
...
| [python](https://www.python.org/) | 3.7.4 | python/3.7.4 | Python programming language | bzip2/1.0.8, ncurses/6.1, readline/8.0, libffi/3.2.1, openssl/1.1.1c |
