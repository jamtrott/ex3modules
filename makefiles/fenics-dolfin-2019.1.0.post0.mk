...
$(fenics-dolfin-2019)-builddeps = $(cmake) $(boost) $(mpi) $(hdf5-parallel) $(parmetis) $(scotch) $(blas) $(gfortran) $(suitesparse) $(metis) $(eigen) $(petsc) $(python) $(python-fenics-dijitso-2019) $(python-fenics-fiat-2019) $(python-fenics-ufl-2019) $(python-fenics-ffc-2019) $(python-pytest)
$(fenics-dolfin-2019)-prereqs = $(boost) $(mpi) $(hdf5-parallel) $(parmetis) $(scotch) $(blas) $(suitesparse) $(metis) $(eigen) $(petsc) $(python) $(python-fenics-dijitso-2019) $(python-fenics-fiat-2019) $(python-fenics-ufl-2019) $(python-fenics-ffc-2019)
...
$($(fenics-dolfin-2019)-prefix)/.pkgunpack: $$($(fenics-dolfin-2019)-src) $($(fenics-dolfin-2019)-srcdir)/.markerfile $($(fenics-dolfin-2019)-prefix)/.markerfile $$(foreach dep,$$($(fenics-dolfin-2019)-builddeps),$(modulefilesdir)/$$(dep))
