...
$(fenics-dolfin-2019)-prereqs = $(boost) $(mpi) $(hdf5-parallel) $(parmetis) $(scotch) $(blas) $(libgfortran) $(suitesparse) $(metis) $(eigen) $(petsc) $(python) $(python-fenics-dijitso-2019) $(python-fenics-fiat-2019) $(python-fenics-ufl-2019) $(python-fenics-ffc-2019)
