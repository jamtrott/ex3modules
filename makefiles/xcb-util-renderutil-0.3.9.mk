...
$($(xcb-util-renderutil)-prefix)/.pkgunpack: $$($(xcb-util-renderutil)-src) $($(xcb-util-renderutil)-srcdir)/.markerfile $($(xcb-util-renderutil)-prefix)/.markerfile $$(foreach dep,$$($(xcb-util-renderutil)-builddeps),$(modulefilesdir)/$$(dep))
