...
$(python-ipython)-src = $(pkgsrcdir)/$(notdir $($(python-ipython)-srcurl))
...
$($(python-ipython)-prefix)/.pkgunpack: $$($(python-ipython)-src) $($(python-ipython)-srcdir)/.markerfile $($(python-ipython)-prefix)/.markerfile
