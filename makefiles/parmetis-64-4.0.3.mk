...
$($(parmetis-64)-prefix)/.pkgpatch: $(modulefilesdir)/.markerfile $$(foreach dep,$$($(parmetis-64)-builddeps),$(modulefilesdir)/$$(dep)) $($(parmetis-64)-prefix)/.pkgunpack $($(parmetis-64)-srcdir)/0002-petsc-bugfix-1.patch $($(parmetis-64)-srcdir)/0003-petsc-bugfix-2.patch
	patch -d $($(parmetis-64)-srcdir) -f -p1 <patches/parmetis-4.0.3-0001-enable_external_metis.patch
