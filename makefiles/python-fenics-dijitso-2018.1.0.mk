...
$(python-fenics-dijitso-2018)-builddeps = $(python) $(blas) $(mpi) $(python-numpy)
...
$(python-fenics-dijitso-2018)-site-packages = $($(python-fenics-dijitso-2018)-prefix)/lib/python$(python-version-short)/site-packages
...
$($(python-fenics-dijitso-2018)-prefix)/.pkgunpack: $$($(python-fenics-dijitso-2018)-src) $($(python-fenics-dijitso-2018)-srcdir)/.markerfile $($(python-fenics-dijitso-2018)-prefix)/.markerfile
...
$($(python-fenics-dijitso-2018)-prefix)/.pkginstall: $(modulefilesdir)/.markerfile $$(foreach dep,$$($(python-fenics-dijitso-2018)-builddeps),$(modulefilesdir)/$$(dep)) $($(python-fenics-dijitso-2018)-prefix)/.pkgcheck $($(python-fenics-dijitso-2018)-site-packages)/.markerfile
	cd $($(python-fenics-dijitso-2018)-srcdir) && \
		...
		python3 setup.py install --prefix=$($(python-fenics-dijitso-2018)-prefix)
	@touch $@
