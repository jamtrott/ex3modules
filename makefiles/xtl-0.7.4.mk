...
xtl-version = 0.7.4
xtl = xtl-$(xtl-version)
$(xtl)-description = The x template library
$(xtl)-url = https://github.com/xtensor-stack/xtl
$(xtl)-srcurl = https://github.com/xtensor-stack/xtl/archive/refs/tags/$(xtl-version).tar.gz
$(xtl)-builddeps = $(cmake)
$(xtl)-prereqs =
...
$($(xtl)-prefix)/.pkgunpack: $$($(xtl)-src) $($(xtl)-srcdir)/.markerfile $($(xtl)-prefix)/.markerfile $$(foreach dep,$$($(xtl)-builddeps),$(modulefilesdir)/$$(dep))
...
$($(xtl)-modulefile): $(modulefilesdir)/.markerfile $($(xtl)-prefix)/.pkginstall
	...
	echo "prepend-path CMAKE_PREFIX_PATH $($(xtl)-prefix)/share/cmake/xtl" >>$@
	echo "set MSG \"$(xtl)\"" >>$@
