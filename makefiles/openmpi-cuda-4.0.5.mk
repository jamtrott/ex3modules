...
$(openmpi-cuda)-srcurl =
$(openmpi-cuda)-builddeps = $(gcc) $(knem) $(hwloc) $(libevent) $(numactl) $(ucx) $(libfabric) $(slurm) $(pmix) $(cuda-toolkit)
$(openmpi-cuda)-prereqs = $(gcc) $(knem) $(hwloc) $(libevent) $(numactl) $(ucx) $(libfabric) $(slurm) $(pmix) $(cuda-toolkit)
