...
$($(xcb-util-image)-prefix)/.pkgunpack: $$($(xcb-util-image)-src) $($(xcb-util-image)-srcdir)/.markerfile $($(xcb-util-image)-prefix)/.markerfile $$(foreach dep,$$($(xcb-util-image)-builddeps),$(modulefilesdir)/$$(dep))
