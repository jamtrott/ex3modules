...
$(llvm-10)-builddeps = $(gcc-10.1.0) $(cmake) $(ninja) $(libffi)
$(llvm-10)-prereqs = $(libstdcxx) $(libffi)
...
$($(llvm-10)-prefix)/.pkgunpack: $($(llvm-10)-src) $($(llvm-10)-srcdir)/.markerfile $($(llvm-10)-prefix)/.markerfile
