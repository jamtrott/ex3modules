...
$(openmpi-4.1.6)-builddeps = $(knem) $(numactl) $(ucx) $(libfabric) $(slurm) $(cuda-toolkit) $(util-linux) $(libevent)
$(openmpi-4.1.6)-prereqs = $(knem) $(numactl) $(ucx) $(libfabric) $(slurm) $(cuda-toolkit) $(util-linux) $(libevent)
