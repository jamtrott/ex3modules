...
$(example)-builddir = $($(example)-srcdir)/build
...
$($(example)-prefix)/.pkgunpack: $$($(example)-src) $($(example)-srcdir)/.markerfile $($(example)-prefix)/.markerfile $$(foreach dep,$$($(example)-builddeps),$(modulefilesdir)/$$(dep))
