...
$(fenics-dolfin-64-2019)-builddeps = $(cmake) $(boost) $(mpi) $(hdf5-parallel) $(parmetis-64) $(scotch-64) $(blas) $(gfortran) $(suitesparse-64) $(metis-64) $(eigen) $(petsc-64) $(python) $(python-fenics-dijitso-2019) $(python-fenics-fiat-2019) $(python-fenics-ufl-2019) $(python-fenics-ffc-2019) $(python-pytest)
$(fenics-dolfin-64-2019)-prereqs = $(boost) $(mpi) $(hdf5-parallel) $(parmetis-64) $(scotch-64) $(blas) $(suitesparse-64) $(metis-64) $(eigen) $(petsc-64) $(python) $(python-fenics-dijitso-2019) $(python-fenics-fiat-2019) $(python-fenics-ufl-2019) $(python-fenics-ffc-2019)
