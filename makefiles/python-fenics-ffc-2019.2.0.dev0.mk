...
$(python-fenics-ffc-2019.2.0.dev0)-srcurl = https://bitbucket.org/fenics-project/ffc/get/a20cbe79390336ea72362f352b049e2b7fe356c8.tar.gz
...
$(python-fenics-ffc-2019.2.0.dev0)-builddeps = $(python) $(blas) $(mpi) $(python-numpy) $(python-mpmath) $(python-sympy-1.4) $(python-fenics-dijitso-2019) $(python-fenics-fiat-2019.2.0.dev0) $(python-fenics-ufl-2021) $(python-fenics-ufl-2021) $(python-setuptools) $(python-wheel) $(python-pip)
$(python-fenics-ffc-2019.2.0.dev0)-prereqs = $(python) $(python-numpy) $(python-mpmath) $(python-sympy-1.4) $(python-fenics-dijitso-2019) $(python-fenics-fiat-2019.2.0.dev0) $(python-fenics-ufl-2021)
