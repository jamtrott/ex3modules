...
$(python-pytest)-builddeps = $(python) $(python-atomicwrites) $(python-pluggy) $(python-wcwidth) $(python-importlib_metadata) $(python-packaging) $(python-py) $(python-more-itertools) $(python-attrs) $(python-zipp) $(python-pyparsing) $(python-six) $(python-toml) $(python-iniconfig)
...
$(python-pytest)-site-packages = $($(python-pytest)-prefix)/lib/python$(python-version-short)/site-packages
...
$($(python-pytest)-prefix)/.pkgunpack: $$($(python-pytest)-src) $($(python-pytest)-srcdir)/.markerfile $($(python-pytest)-prefix)/.markerfile
...
$($(python-pytest)-prefix)/.pkginstall: $(modulefilesdir)/.markerfile $$(foreach dep,$$($(python-pytest)-builddeps),$(modulefilesdir)/$$(dep)) $($(python-pytest)-prefix)/.pkgcheck $($(python-pytest)-site-packages)/.markerfile
	cd $($(python-pytest)-srcdir) && \
		...
		python3 setup.py install --prefix=$($(python-pytest)-prefix)
	@touch $@
