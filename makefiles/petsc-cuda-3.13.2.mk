...
$(petsc-cuda)-srcurl =
$(petsc-cuda)-builddeps = $(gcc) $(boost) $(blas) $(openmpi-cuda) $(hwloc) $(hypre) $(metis) $(mumps) $(parmetis) $(python) $(scalapack) $(scotch) $(suitesparse) $(superlu) $(superlu_dist) $(cuda-toolkit) $(patchelf)
$(petsc-cuda)-prereqs = $(gcc) $(boost) $(blas) $(openmpi-cuda) $(hwloc) $(hypre) $(metis) $(mumps) $(parmetis) $(scalapack) $(scotch) $(suitesparse) $(superlu) $(superlu_dist) $(cuda-toolkit)
