...
$(petsc-cuda)-srcurl =
$(petsc-cuda)-builddeps = $(boost) $(blas) $(openmpi-cuda) $(hwloc) $(hypre-cuda) $(metis) $(mumps-cuda) $(parmetis-cuda) $(python) $(scalapack-cuda) $(scotch-cuda) $(suitesparse) $(superlu) $(superlu_dist-cuda) $(cuda-toolkit) $(patchelf)
$(petsc-cuda)-prereqs = $(boost) $(blas) $(openmpi-cuda) $(hwloc) $(hypre-cuda) $(metis) $(mumps-cuda) $(parmetis-cuda) $(scalapack-cuda) $(scotch-cuda) $(suitesparse) $(superlu) $(superlu_dist-cuda) $(cuda-toolkit)
