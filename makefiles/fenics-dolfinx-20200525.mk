...
$(fenics-dolfinx-20200525)-builddeps = $(cmake) $(ninja) $(boost) $(mpi) $(hdf5-parallel) $(parmetis) $(scotch) $(suitesparse) $(metis) $(eigen) $(petsc) $(python) $(python-fenics-fiat-20200518) $(python-fenics-ufl-20200512) $(python-fenics-ffcx-20200522) $(python-pytest)
$(fenics-dolfinx-20200525)-prereqs = $(boost) $(mpi) $(hdf5-parallel) $(parmetis) $(scotch) $(suitesparse) $(metis) $(eigen) $(petsc) $(python)  $(python-fenics-fiat-20200518) $(python-fenics-ufl-20200512) $(python-fenics-ffcx-20200522)
