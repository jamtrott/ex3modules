...
$(patchelf)-builddeps = 
$(patchelf)-prereqs = 
$(patchelf)-src = $(pkgsrcdir)/patchelf-$(notdir $($(patchelf)-srcurl))
...
$($(patchelf)-prefix)/.pkgunpack: $($(patchelf)-src) $($(patchelf)-srcdir)/.markerfile $($(patchelf)-prefix)/.markerfile $$(foreach dep,$$($(patchelf)-builddeps),$(modulefilesdir)/$$(dep))
