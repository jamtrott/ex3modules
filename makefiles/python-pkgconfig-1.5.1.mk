...
$(python-pkgconfig)-site-packages = $($(python-pkgconfig)-prefix)/lib/python$(python-version-short)/site-packages
...
$($(python-pkgconfig)-prefix)/.pkgunpack: $$($(python-pkgconfig)-src) $($(python-pkgconfig)-srcdir)/.markerfile $($(python-pkgconfig)-prefix)/.markerfile
...
$($(python-pkgconfig)-prefix)/.pkginstall: $(modulefilesdir)/.markerfile $$(foreach dep,$$($(python-pkgconfig)-builddeps),$(modulefilesdir)/$$(dep)) $($(python-pkgconfig)-prefix)/.pkgcheck $($(python-pkgconfig)-site-packages)/.markerfile
	cd $($(python-pkgconfig)-srcdir) && \
		...
		python3 setup.py install --prefix=$($(python-pkgconfig)-prefix)
	@touch $@
