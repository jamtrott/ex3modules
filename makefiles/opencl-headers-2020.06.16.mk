...
$(opencl-headers)-srcurl = https://github.com/KhronosGroup/OpenCL-Headers/archive/v2020.06.16.tar.gz
$(opencl-headers)-builddeps =
$(opencl-headers)-prereqs =
$(opencl-headers)-src = $(pkgsrcdir)/$(notdir $($(opencl-headers)-srcurl))
