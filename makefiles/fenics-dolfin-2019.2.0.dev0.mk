...
$(fenics-dolfin-2019.2.0.dev0)-builddeps = $(cmake) $(boost) $(mpi) $(hdf5-parallel) $(parmetis) $(scotch) $(blas) $(gfortran) $(suitesparse) $(metis) $(eigen) $(petsc) $(python) $(python-fenics-dijitso-2019) $(python-fenics-fiat-2019.2.0.dev0) $(python-fenics-ufl-2021) $(python-fenics-ffc-2019.2.0.dev0) $(python-pytest)
$(fenics-dolfin-2019.2.0.dev0)-prereqs = $(boost) $(mpi) $(hdf5-parallel) $(parmetis) $(scotch) $(blas) $(suitesparse) $(metis) $(eigen) $(petsc) $(python) $(python-fenics-dijitso-2019) $(python-fenics-fiat-2019.2.0.dev0) $(python-fenics-ufl-2021) $(python-fenics-ffc-2019.2.0.dev0)
