...
$(mesa)-srcurl = https://archive.mesa3d.org/mesa-$(mesa-version).tar.xz
$(mesa)-builddeps = $(meson) $(ninja) $(python) $(python-mako) $(llvm) $(libxv) $(libxvmc) $(flex) $(bison) $(libunwind) $(libdrm) $(expat) $(libx11) $(libxext) $(libxfixes) $(libxrandr) $(libxshmfence) $(libxxf86vm) $(xcb-proto)
$(mesa)-prereqs = $(llvm) $(libxv) $(libxvmc) $(libunwind) $(libdrm) $(expat) $(libx11) $(libxext) $(libxfixes) $(libxrandr) $(libxshmfence) $(libxxf86vm) $(xcb-proto)
