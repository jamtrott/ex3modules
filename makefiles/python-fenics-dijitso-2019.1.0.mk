...
$(python-fenics-dijitso-2019)-builddeps = $(python) $(blas) $(mpi) $(python-numpy)
$(python-fenics-dijitso-2019)-prereqs = $(gcc-10.1.0) $(python) $(python-numpy)
...
$($(python-fenics-dijitso-2019)-prefix)/.pkgunpack: $$($(python-fenics-dijitso-2019)-src) $($(python-fenics-dijitso-2019)-srcdir)/.markerfile $($(python-fenics-dijitso-2019)-prefix)/.markerfile
...
$($(python-fenics-dijitso-2019)-prefix)/.pkginstall: $(modulefilesdir)/.markerfile $$(foreach dep,$$($(python-fenics-dijitso-2019)-builddeps),$(modulefilesdir)/$$(dep)) $($(python-fenics-dijitso-2019)-prefix)/.pkgcheck $($(python-fenics-dijitso-2019)-site-packages)/.markerfile
	cd $($(python-fenics-dijitso-2019)-srcdir) && \
		...
		python3 setup.py install --prefix=$($(python-fenics-dijitso-2019)-prefix)
	@touch $@
