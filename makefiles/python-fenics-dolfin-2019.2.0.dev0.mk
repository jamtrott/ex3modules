...
$(python-fenics-dolfin-2019.2.0.dev0)-builddeps = $(python) $(cmake) $(blas) $(mpi) $(python-cffi) $(python-numpy) $(python-pkgconfig) $(python-fenics-dijitso-2019) $(python-fenics-fiat-2019.2.0.dev0) $(python-fenics-ufl-legacy-2022.3.0) $(python-fenics-ffc-2019.2.0.dev0) $(pybind11) $(python-ply) $(python-mpi4py) $(python-petsc4py) $(fenics-dolfin-2019.2.0.dev0) $(python-wheel) $(python-pip)
$(python-fenics-dolfin-2019.2.0.dev0)-prereqs = $(python) $(python-cffi) $(python-numpy) $(python-pkgconfig) $(python-fenics-dijitso-2019) $(python-fenics-fiat-2019.2.0.dev0) $(python-fenics-ufl-legacy-2022.3.0) $(python-fenics-ffc-2019.2.0.dev0) $(pybind11) $(python-ply) $(python-mpi4py) $(python-petsc4py) $(fenics-dolfin-2019.2.0.dev0)
