...
$(python-matplotlib)-builddeps = $(python) $(freetype) $(libpng) $(blas) $(mpi) $(python-numpy) $(python-kiwisolver) $(python-dateutil) $(python-pytest) $(python-cycler) $(python-pyparsing) $(python-pillow) $(python-importlib_resources) $(python-pip) $(python-packaging) $(python-contourpy) $(python-fonttools)
$(python-matplotlib)-prereqs = $(python) $(freetype) $(libpng) $(python-numpy) $(python-kiwisolver) $(python-dateutil) $(python-pyparsing) $(python-cycler) $(python-pillow) $(python-importlib_resources) $(python-packaging) $(python-contourpy) $(python-fonttools)
