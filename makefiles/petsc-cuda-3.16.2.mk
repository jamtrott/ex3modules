...
$($(petsc-cuda-3.16.2)-prefix)/.pkgunpack: $$($(petsc-cuda-3.16.2)-src) $($(petsc-cuda-3.16.2)-srcdir)/.markerfile $($(petsc-cuda-3.16.2)-prefix)/.markerfile $$(foreach dep,$$($(petsc-cuda-3.16.2)-builddeps),$(modulefilesdir)/$$(dep))
