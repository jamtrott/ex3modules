...
$(petsc-cuda-3.16.2)-builddeps = $(gcc) $(boost) $(blas) $(openmpi-cuda) $(hwloc) $(hypre-cuda) $(metis) $(mumps-cuda) $(parmetis-cuda) $(python) $(scalapack-cuda) $(scotch-cuda) $(suitesparse) $(superlu) $(superlu_dist-cuda) $(cuda-toolkit) $(patchelf)
$(petsc-cuda-3.16.2)-prereqs = $(gcc) $(boost) $(blas) $(openmpi-cuda) $(hwloc) $(hypre-cuda) $(metis) $(mumps-cuda) $(parmetis-cuda) $(scalapack-cuda) $(scotch-cuda) $(suitesparse) $(superlu) $(superlu_dist-cuda) $(cuda-toolkit)
...
$($(petsc-cuda-3.16.2)-prefix)/.pkgunpack: $$($(petsc-3.16.2)-src) $($(petsc-cuda-3.16.2)-srcdir)/.markerfile $($(petsc-cuda-3.16.2)-prefix)/.markerfile
