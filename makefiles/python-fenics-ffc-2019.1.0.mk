...
$(python-fenics-ffc-2019)-builddeps = $(python) $(blas) $(mpi) $(python-numpy) $(python-mpmath) $(python-sympy-1.4) $(python-fenics-dijitso-2019) $(python-fenics-fiat-2019) $(python-fenics-ufl-2019)
...
$(python-fenics-ffc-2019)-site-packages = $($(python-fenics-ffc-2019)-prefix)/lib/python$(python-version-short)/site-packages
...
$($(python-fenics-ffc-2019)-prefix)/.pkgunpack: $$($(python-fenics-ffc-2019)-src) $($(python-fenics-ffc-2019)-srcdir)/.markerfile $($(python-fenics-ffc-2019)-prefix)/.markerfile
...
$($(python-fenics-ffc-2019)-prefix)/.pkginstall: $(modulefilesdir)/.markerfile $$(foreach dep,$$($(python-fenics-ffc-2019)-builddeps),$(modulefilesdir)/$$(dep)) $($(python-fenics-ffc-2019)-prefix)/.pkgcheck $($(python-fenics-ffc-2019)-site-packages)/.markerfile $($(python-fenics-ffc-2019)-prefix)/include/ufc.h $($(python-fenics-ffc-2019)-prefix)/include/ufc_geometry.h
	cd $($(python-fenics-ffc-2019)-srcdir) && \
		...
		python3 setup.py install --prefix=$($(python-fenics-ffc-2019)-prefix)
	@touch $@
