...
#   MODULES_PREFIX=$HOME module load mpc
#
set -o errexit
...
pkg_description="Library for arbitrary precision complex arithmetic with correct rounding"
pkg_url="http://www.multiprecision.org/mpc"
...
setenv MPCDIR \$MODULES_PREFIX${pkg_prefix}
setenv MPCLIB \$MODULES_PREFIX${pkg_prefix}/lib
