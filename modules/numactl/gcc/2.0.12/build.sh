...
#   MODULES_PREFIX=$HOME module load numactl
#
set -x -o errexit
...
pkg_description="NUMA support for Linux"
pkg_url="https://github.com/numactl/numactl"
src_url="https://github.com/numactl/numactl/releases/download/v${pkg_version}/${pkg_name}-${pkg_version}.tar.gz"
