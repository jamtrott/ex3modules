...
pkg_description="C library for multiple-precision floating-point computations"
pkg_url="https://www.mpfr.org"
src_url="https://ftp.gnu.org/gnu/mpfr/mpfr-${pkg_version}.tar.gz"
...
setenv MPFRDIR \$MODULES_PREFIX${pkg_prefix}
setenv MPFRLIB \$MODULES_PREFIX${pkg_prefix}/lib
