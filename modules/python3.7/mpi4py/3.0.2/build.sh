...
#   MODULES_PREFIX=$HOME module load python<version>/mpi4py
#
set -o errexit
...
pkg_description="Python bindings for the Message Passing Interface (MPI)"
pkg_url="https://mpi4py.readthedocs.io/"
