...
#   MODULES_PREFIX=$HOME module load libtool
#
set -x -o errexit
...
PKG_DESCRIPTION="The GNU Portable Library Tool"
PKG_URL="https://www.gnu.org/software/libtool/"
SRC_URL=http://ftpmirror.gnu.org/libtool/libtool-2.4.6.tar.gz
