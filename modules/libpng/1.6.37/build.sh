...
pkg_description="Official Portable Network Graphics reference library for handling PNG images"
pkg_url="http://www.libpng.org/pub/png/libpng.html"
src_url="https://download.sourceforge.net/libpng/libpng-${pkg_version}.tar.gz"
