...
# Configure environment to use the newly installed dolfin package
# export DOLFIN_ROOT=${DESTDIR}${PKG_PREFIX}
export PATH=${DESTDIR}${PKG_PREFIX}/bin:${PATH}
export C_INCLUDE_PATH=${DESTDIR}${PKG_PREFIX}/include:${C_INCLUDE_PATH}
export CPLUS_INCLUDE_PATH=${DESTDIR}${PKG_PREFIX}/include:${CPLUS_INCLUDE_PATH}
export LIBRARY_PATH=${DESTDIR}${PKG_PREFIX}/lib:${LIBRARY_PATH}
export LD_LIBRARY_PATH=${DESTDIR}${PKG_PREFIX}/lib:${LD_LIBRARY_PATH}
export CMAKE_MODULE_PATH=${DESTDIR}${PKG_PREFIX}/share/dolfin/cmake:${CMAKE_MODULE_PATH}
